...
from .views import (TagApiDetail, TagApiList, StartupAPIDetail, StartupAPIList,
                    NewsLinkAPIList, NewsLinkAPIDetail)
...
urlpatterns = [
    ...
    path('newslink/<str:startup-slug>/<str:newslink-slug>', NewsLinkAPIDetail.as_view(), name='api-newslink-detail')
]
